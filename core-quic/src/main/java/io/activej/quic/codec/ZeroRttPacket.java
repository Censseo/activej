...
/**
 * 0-RTT packet (RFC 9000 §17.2.3). Structural shape only — no early-data semantics.
 * {@link #packetNumber} is the raw truncated value (see {@link QuicPacket}); {@link #payload} is
 * the unprotected packet payload. Owns a retained slice of {@link #payload} — the caller must
 * {@link #recycle()} it after use.
 */
public final class ZeroRttPacket extends QuicLongHeaderPacket implements Recyclable {
	public static final int LONG_PACKET_TYPE = 0x1;
	...
	public void writeTo(ByteBuf buf) {
		buf.writeByte((byte) (0xD0 | (packetNumberLength - 1)));
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof ZeroRttPacket other)) return false;
