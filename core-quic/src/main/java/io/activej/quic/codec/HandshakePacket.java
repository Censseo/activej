...
/**
 * Handshake packet (RFC 9000 §17.2.4). {@link #packetNumber} is the raw truncated value (see
 ...
 */
public final class HandshakePacket extends QuicLongHeaderPacket implements Recyclable {
	public static final int LONG_PACKET_TYPE = 0x2;
	...
	public void writeTo(ByteBuf buf) {
		buf.writeByte((byte) (0xE0 | (packetNumberLength - 1)));
	...
	public boolean equals(Object o) {
		...
		if (!(o instanceof HandshakePacket other)) return false;
