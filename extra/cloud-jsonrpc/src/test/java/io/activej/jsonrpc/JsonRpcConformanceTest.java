...
import static io.activej.jsonrpc.ConformanceJson.idOf;
import static io.activej.jsonrpc.ConformanceJson.jsonEquals;
...
public class JsonRpcConformanceTest {
	...
	// ---------------------------------------------------------------------------------------------------
	// Local helpers. Contract 3's comparison rules 1 and 2 live in ConformanceJson, next to the loader of
	// the same files — this suite and feature 03's transport harness are both readers of the vector format,
	// and neither is the other's dependency.
	// ---------------------------------------------------------------------------------------------------
