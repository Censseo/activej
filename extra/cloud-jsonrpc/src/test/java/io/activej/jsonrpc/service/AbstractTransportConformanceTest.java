...
public abstract class AbstractTransportConformanceTest {
	...
	// ---------------------------------------------------------------------------------------------------
	// Local helpers. Rules 1 and 2 of FR-092a live in ConformanceJson, next to the loader of the same files:
	// they are the vector FORMAT's rules, and feature 01's decoder-level JsonRpcConformanceTest applies the
	// same ones without either suite becoming the other's dependency.
	// ---------------------------------------------------------------------------------------------------
