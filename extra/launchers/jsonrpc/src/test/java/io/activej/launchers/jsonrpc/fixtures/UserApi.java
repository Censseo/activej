...
/** The fixture service of this module's launcher tests: one call and one notification under {@code user}. */
@JsonRpcService("user")
public interface UserApi {
	/** The identified call — the fixture's wire names are {@code user.get} and {@code user.touch}. */
	@JsonRpcMethod("get")
	Promise<User> getUser(@JsonRpcParam("id") long id);

	/** The notification — never answered. */
